...
class TaskManagerViewTests(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            username="test.user123", password="test.password12"
        )
    ...
    def test_project_update_view(self):
        ...
        self.assertTemplateUsed(
            response, "task_manager/project/project_form.html"
        )
        updated_data = {
    ...
    def test_project_delete_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "task_manager/project/project_delete.html"
        )
    ...
    def test_task_detail_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "task_manager/task/task_detail.html"
        )
    ...
    def test_task_delete_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "task_manager/task/task_delete.html"
        )
    ...
    def test_team_delete_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "task_manager/team/team_delete.html"
        )
    ...
    def test_worker_detail_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "task_manager/worker/worker_detail.html"
        )
    ...
    def test_worker_delete_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(
            response, "task_manager/worker/worker_delete.html"
        )

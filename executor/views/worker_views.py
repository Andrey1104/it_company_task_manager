...
from executor.models import Worker, Task
from utils.mixins import ModelDeleteMixin
...
class WorkerUpdateView(LoginRequiredMixin, generic.UpdateView):
    ...
    template_name = "task_manager/worker/worker_form.html"
    success_url = reverse_lazy("executor:worker_list")
...
class WorkerTaskDeleteView(
    ...
    def get(self, request, *args, **kwargs):
        ...
        return HttpResponseRedirect(
            reverse_lazy("executor:worker_detail", args=[worker_id])
        )
